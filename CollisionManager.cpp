...
bool CollisionManager::HitCheckSphereToSphere(const SphereCollider* collider1, const SphereCollider* collider2)
{
	// 球の中心の差
	DirectX::SimpleMath::Vector3 sub = collider1->GetPosition() - collider2->GetPosition();
